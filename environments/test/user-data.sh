...
# ==============================================
# EC2 Initial Setup Script (Test Environment)
# 
...
echo "=========================================="
echo "Starting EC2 setup for Test environment..."
echo "=========================================="
...
echo "   - EC2_HOST_TEST: $(curl -s http://169.254.169.254/latest/meta-data/public-ipv4 2>/dev/null || echo '<EC2_PUBLIC_IP>')"
echo "   - EC2_KEY_TEST: SSH Private Key"
echo ""
